...
const Header = () => {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 w-full z-50 p-5 lg:px-10 transition-all duration-300 ${isScroll ? "backdrop-blur-md bg-black/20 text-white" : "text-white/80"}`}>
